...
@Component({
  selector: 'app-modal-appointment-registration',
  templateUrl: './modal-appointment-registration.component.html',
  styleUrl: './modal-appointment-registration.component.css'
})
export class ModalAppointmentRegistrationComponent implements OnInit {
